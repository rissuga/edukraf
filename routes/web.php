...
use App\Http\Controllers\frontend\WbnrController;
...
Route::prefix('')->group(function () {
    ...
    Route::get('/webinar', [WbnrController::class, 'show'])->name('webinar');
    Route::get('/webinar/soon', [WbnrController::class, 'show_soon'])->name('webinar_soon');
    Route::get('/webinar/done', [WbnrController::class, 'show_done'])->name('webinar_done');
    Route::get('/webinar/detail{id}', [WbnrController::class, 'detail'])->name('webinardetail');
